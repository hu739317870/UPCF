...
class DfsPredictionRate(object):
    ...
    def dfs_prediction_one_user_rate(self, target_user, target_item, k=150):
    ...
    def dfs_prediction(self):
        ...
        DivideData.export_file('ml-1m/prediction_rate_pcc_dfm.csv', Prediction_rate_matrix)
        '''
        更改相似度文件后，记得更改导出的文件名
        '''
...
if __name__ == '__main__':
    ...
    sim_file = os.path.join('ml-1m', 'PCC_sim.csv')
    '''
