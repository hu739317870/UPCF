...
class GenerateCOSUPsim(object):
    ...
    def generate_user_profile(self, user_profile_file):
        G = ['F', 'M']
        A = ['Tee', 'Adu', 'Mat', 'Old']
        O = ['Tec', 'Rec', 'Ope', 'Obj', 'Else']
        G_A = ['F', 'M', 'Tee', 'Adu', 'Mat', 'Old']
        G_O = ['F', 'M', 'Tec', 'Rec', 'Ope', 'Obj', 'Else']
        A_O = ['Tee', 'Adu', 'Mat', 'Old', 'Tec', 'Rec', 'Ope', 'Obj', 'Else']
    ...
    def generate_COS_UPsim(self):
        ...
        DivideData.export_file('ml-1m/COS_UPsim_G.csv', COS_UPsim_matrix)
